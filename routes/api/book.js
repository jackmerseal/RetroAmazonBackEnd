...
const newBookSchema = Joi.object({
  ...
  genre: Joi.string()
    .valid('Adventure', 'Fiction', 'Mystery', 'Non-Fiction')
    .required(),
  publication_year: Joi.number().integer().min(1800).max(2023).required(),
...
const updateBookSchema = Joi.object({
  ...
  genre: Joi.string().valid('Adventure', 'Fiction', 'Mystery', 'Non-Fiction'),
  publication_year: Joi.number().integer().min(1800).max(2023),
